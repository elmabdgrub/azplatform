...
class Notificationt
{
     ...
     * Set messagetache
     *
     * @param \BackOfficeBundle\Entity\MessageTache $messagetache
     * @return Notificationt
     */
    public function setMessagetache(\BackOfficeBundle\Entity\MessageTache $messagetache)
    {
        $this->messagetache = $messagetache;
     ...
     * Get messagetache
     *
     * @return \BackOfficeBundle\Entity\MessageTache 
     */
    public function getMessagetache()
    {
        return $this->messagetache;
    }
}
