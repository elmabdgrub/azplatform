 ...
 */
class TagsProjet extends \BackOfficeBundle\Entity\TagsProjet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\TagsProjet' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\TagsProjet' . "\0" . 'tag', '' . "\0" . 'BackOfficeBundle\\Entity\\TagsProjet' . "\0" . 'projet');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TagsProjet $proxy) {
