 ...
 */
class MessageProjet extends \BackOfficeBundle\Entity\MessageProjet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\MessageProjet' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\MessageProjet' . "\0" . 'message', '' . "\0" . 'BackOfficeBundle\\Entity\\MessageProjet' . "\0" . 'datemessage', '' . "\0" . 'BackOfficeBundle\\Entity\\MessageProjet' . "\0" . 'notified', '' . "\0" . 'BackOfficeBundle\\Entity\\MessageProjet' . "\0" . 'projet', '' . "\0" . 'BackOfficeBundle\\Entity\\MessageProjet' . "\0" . 'collaborateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageProjet $proxy) {
