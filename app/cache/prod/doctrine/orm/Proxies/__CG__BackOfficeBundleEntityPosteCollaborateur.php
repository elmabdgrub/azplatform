 ...
 */
class PosteCollaborateur extends \BackOfficeBundle\Entity\PosteCollaborateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\PosteCollaborateur' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\PosteCollaborateur' . "\0" . 'libelle', '' . "\0" . 'BackOfficeBundle\\Entity\\PosteCollaborateur' . "\0" . 'service');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PosteCollaborateur $proxy) {
