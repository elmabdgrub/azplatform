 ...
 */
class TagsPoste extends \BackOfficeBundle\Entity\TagsPoste implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\TagsPoste' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\TagsPoste' . "\0" . 'tag', '' . "\0" . 'BackOfficeBundle\\Entity\\TagsPoste' . "\0" . 'collaborateur');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TagsPoste $proxy) {
