 ...
 */
class Collaborateur extends \BackOfficeBundle\Entity\Collaborateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'nom', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'prenom', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'email', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'telephone', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'password', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'lastvisite', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'active', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'postecollaborateur', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'path', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'fav', 'file', '' . "\0" . 'BackOfficeBundle\\Entity\\Collaborateur' . "\0" . 'temp');
        }
    ...
    public function setLastvisite($lastvisite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLastvisite', array($lastvisite));

        return parent::setLastvisite($lastvisite);
    }
    ...
    public function getLastvisite()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastvisite', array());

        return parent::getLastvisite();
    }

    /**
     * {@inheritDoc}
     */
    public function setPostecollaborateur(\BackOfficeBundle\Entity\PosteCollaborateur $postecollaborateur)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPostecollaborateur', array($postecollaborateur));

        return parent::setPostecollaborateur($postecollaborateur);
    }
    ...
    public function getPostecollaborateur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPostecollaborateur', array());

        return parent::getPostecollaborateur();
    }
    ...
    public function setFav($fav)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFav', array($fav));

        return parent::setFav($fav);
    }
    ...
    public function getFav()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFav', array());

        return parent::getFav();
    }
