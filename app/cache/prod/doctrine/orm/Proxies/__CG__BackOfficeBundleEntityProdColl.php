 ...
 */
class ProdColl extends \BackOfficeBundle\Entity\ProdColl implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\ProdColl' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\ProdColl' . "\0" . 'dateAffectation', '' . "\0" . 'BackOfficeBundle\\Entity\\ProdColl' . "\0" . 'tache', '' . "\0" . 'BackOfficeBundle\\Entity\\ProdColl' . "\0" . 'collaborateur', '' . "\0" . 'BackOfficeBundle\\Entity\\ProdColl' . "\0" . 'notified');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProdColl $proxy) {
