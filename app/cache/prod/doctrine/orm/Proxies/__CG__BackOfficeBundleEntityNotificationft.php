 ...
 */
class Notificationft extends \BackOfficeBundle\Entity\Notificationft implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BackOfficeBundle\\Entity\\Notificationft' . "\0" . 'id', '' . "\0" . 'BackOfficeBundle\\Entity\\Notificationft' . "\0" . 'notified', '' . "\0" . 'BackOfficeBundle\\Entity\\Notificationft' . "\0" . 'type', '' . "\0" . 'BackOfficeBundle\\Entity\\Notificationft' . "\0" . 'description', '' . "\0" . 'BackOfficeBundle\\Entity\\Notificationft' . "\0" . 'fichiertache', '' . "\0" . 'BackOfficeBundle\\Entity\\Notificationft' . "\0" . 'collaborateur', '' . "\0" . 'BackOfficeBundle\\Entity\\Notificationft' . "\0" . 'datenotif');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Notificationft $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setFichiertache(\BackOfficeBundle\Entity\FichierTache $fichiertache)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFichiertache', array($fichiertache));

        return parent::setFichiertache($fichiertache);
    }
    ...
    public function getFichiertache()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFichiertache', array());

        return parent::getFichiertache();
    }
