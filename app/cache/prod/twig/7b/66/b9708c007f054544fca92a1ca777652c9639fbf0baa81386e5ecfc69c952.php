...
\t\t\t\t\t\t\t\t<strong>Description : </strong>";
        // line 39
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "description", array()), "html", null, true);
        echo "<br><br>
...
\t\t\t\t\t\t\t\t<strong>Date d'expiration : </strong>";
        // line 41
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "dateexpiration", array()), "d/m/Y"), "html", null, true);
        echo " <br><br>
\t\t\t\t\t\t\t\t<strong>Date de renouvellement : </strong>";
        // line 42
        if (($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "daterenouv", array()) == null)) {
            echo "-";
        } else {
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "daterenouv", array()), "d/m/Y"), "html", null, true);
        }
        echo " <br><br>
...
\t\t\t\t\t\t";
        // line 54
        $context["photo"] = ("logosclient/" . $this->getAttribute($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "client", array()), "path", array()));
        // line 55
        echo "\t\t\t\t\t\t\t<li>

\t\t\t\t\t\t\t\t";
        // line 57
        if (($this->getAttribute($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "client", array()), "path", array()) == "")) {
            // line 58
...
\t\t\t\t\t\t\t\t<strong>Nom : </strong> ";
        // line 64
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "client", array()), "nom", array()), "html", null, true);
        echo "<br>
\t\t\t\t\t\t\t\t<strong>Téléphone : </strong>";
        // line 65
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "client", array()), "telephone", array()), "html", null, true);
        echo " <br>

\t\t\t\t\t\t\t\t<strong>Email : </strong>";
        // line 67
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "client", array()), "email", array()), "html", null, true);
        echo "<br>
\t\t\t\t\t\t\t\t<center><strong>Site Web : </strong>";
        // line 68
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "client", array()), "site", array()), "html", null, true);
        echo "</center>
\t\t\t\t\t\t\t\t<strong>Adresse : </strong>";
        // line 69
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "client", array()), "adresse", array()), "html", null, true);
        echo "<br>
\t\t\t\t\t\t\t</li>
...
";
        ...
        // line 80
        echo "\t\t\t\t\t\t";
        if ((((isset($context["rest"]) ? $context["rest"] : null) <= 40) && ((isset($context["rest"]) ? $context["rest"] : null) > 0))) {
            // line 81
...
\t\t\t<a href=\"";
            // line 87
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("notifier-hebergement", array("id" => $this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "id", array()), "client" => $this->getAttribute($this->getAttribute((isset($context["hebergement"]) ? $context["hebergement"] : null), "client", array()), "id", array()))), "html", null, true);
            echo "\"> Notifier le client</a>
\t\t</div>
\t</div>
";
        } elseif ((((isset($context["rest"]) ? $context["rest"] : null) > 40) && ((isset($context["rest"]) ? $context["rest"] : null) <= 80))) {
            // line 91
