...
\t\t\t\t\t\t\t  ";
        // line 118
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "tags", array()), 'widget', array("id" => "mySingleField", "attr" => array("class" => "input-prepend")));
        echo "
