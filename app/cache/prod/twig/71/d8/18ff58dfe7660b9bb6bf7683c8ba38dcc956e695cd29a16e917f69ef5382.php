...
/* BackOfficeBundle::frontlayout.html.twig */
class __TwigTemplate_71d818ff58dfe7660b9bb6bf7683c8ba38dcc956e695cd29a16e917f69ef5382 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        try {
            $this->parent = $this->env->loadTemplate("::frontlayout.html.twig");
...
\t\t\t\t\t\t\t\t<li><a href=\"";
        // line 59
        echo $this->env->getExtension('routing')->getPath("edit-profil");
        echo "\"><i class=\"halflings-icon user\"></i> Profil</a></li>
\t\t\t\t\t\t\t\t<li><a href=\"";
        // line 60
        echo $this->env->getExtension('routing')->getPath("frontlogout");
...
\t\t\turl: \"";
        // line 99
        echo $this->env->getExtension('routing')->getPath("notification-collaborateur-message");
        echo "\",
\t\t\tsuccess:
\t\t\t\t\tfunction(retour){
...
\t\t\t\t\t\t\t\t\tstr += \"<li><a href='";
        // line 117
        echo sprintf($this->env->getExtension('routing')->getPath("detail-projet", array("id" => "%s")), "\"+pt+\"");
        echo " '><span class='avatar'><img class='avatar' alt='Dennis Ji' src='";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("img/avatar.jpg"), "html", null, true);
        echo "'></span><span class='header'><span class='from'>\" + msg['collaborateur'][j] + \" </span><br><span class='label label-important'> p </span><span class='message'> \"+msg['projet'][j]+\"</span><br/><span class='time'>\" + date + \"</span><br/><span class='message'>\" + msg['message'][j] + \"</span></a></li>\";
\t\t\t\t\t\t\t\t}else{
\t\t\t\t\t\t\t\t\tstr += \"<li><a href='";
        // line 119
        echo sprintf($this->env->getExtension('routing')->getPath("detail-projet", array("id" => "%s")), "\"+pt+\"");
...
\t\t\t\t\t\t\t\t\tstr += \"<li><a href='";
        // line 126
        echo sprintf($this->env->getExtension('routing')->getPath("detail-tache", array("id" => "%s")), "\"+pt+\"");
        echo " '><span class='avatar'><img class='avatar' alt='Dennis Ji' src='";
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("img/avatar.jpg"), "html", null, true);
        echo "'></span><span class='header'><span class='from'>\" + msg['collaborateur'][j] + \" </span><br><span class='label label-success'> t </span><span class='message'> \" + msg['projet'][j] + \"</span><br/><span class='time'>\" + date + \"</span><br/><span class='message'>\" + msg['message'][j] + \"</span></a></li>\";
\t\t\t\t\t\t\t\t}else{
\t\t\t\t\t\t\t\t\tstr += \"<li><a href='";
        // line 128
        echo sprintf($this->env->getExtension('routing')->getPath("detail-tache", array("id" => "%s")), "\"+pt+\"");
...
\t\t\turl: \"";
        // line 143
        echo $this->env->getExtension('routing')->getPath("notification-collaborateur-fichier");
        echo "\",
\t\t\tsuccess:
\t\t\t\t\tfunction(retour){
...
\t\t\turl: \"";
        // line 181
        echo $this->env->getExtension('routing')->getPath("taches-en-cours");
        echo "\",
\t\t\tsuccess:
\t\t\t\t\tfunction(retour){
...
\t\t\t\t\t\t\t\tstr += \"<li><a href='";
        // line 199
        echo sprintf($this->env->getExtension('routing')->getPath("detail-tache", array("id" => "%s")), "\"+tache+\"");
        echo " '><span class='header'><span class='label label-success'> nouvelle tâche </span><br/><span class='time'>\" + date + \"</span><br/><span class='message'>L'administrateur vous a affecté une nouvelle tâche : \" + msg['tache'][j] + \"</span></a></li>\";
...
";
    ...
    {
        return array (  334 => 199,  313 => 181,  292 => 165,  283 => 161,  262 => 143,  242 => 128,  235 => 126,  223 => 119,  216 => 117,  195 => 99,  187 => 95,  184 => 94,  175 => 82,  172 => 81,  163 => 88,  161 => 81,  152 => 75,  146 => 71,  143 => 70,  136 => 68,  133 => 67,  122 => 60,  118 => 59,  110 => 53,  102 => 51,  100 => 50,  54 => 6,  51 => 5,  44 => 3,  41 => 2,  11 => 1,);
    }
}
