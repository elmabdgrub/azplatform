...
/* BackOfficeBundle:Depense:edit.html.twig */
class __TwigTemplate_f6b2b2c5cfc4128f105761adc2a442644c65b035c51f1ca89ca59b211ad087bd extends Twig_Template
{
...
\t\t\t\t\t\t<h2><i class=\"halflings-icon white edit\"></i><span class=\"break\"></span>Modifier dépense</h2>
\t\t\t\t\t\t<div class=\"box-icon\">
\t\t\t\t\t\t\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t ";
        // line 32
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "typedepense", array()), 'widget', array("attr" => array("class" => "chzn-done")));
        echo "
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t  </div>
\t\t\t\t\t\t\t
...
";
    ...
    {
        return "BackOfficeBundle:Depense:edit.html.twig";
    }
