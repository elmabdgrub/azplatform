...
/* BackOfficeBundle:StatutProjet:list.html.twig */
class __TwigTemplate_ad8a99136da65be5df82bcd23c493016e53bfcfb8cb8bbd06c24c2f877308417 extends Twig_Template
{
    ...
    {
        // line 4
        echo "\tListe des statuts de projets  ";
...
\t\t\t\t<h2><i class=\"halflings-icon white user\"></i><span class=\"break\"></span>Statuts de projets</h2>
\t\t\t\t<div class=\"box-icon\">
...
\t\t\t\t\t";
        // line 47
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["listestatutsprojets"]) ? $context["listestatutsprojets"] : $this->getContext($context, "listestatutsprojets")));
...
\t\t\t\t\t\t\t\t<a class=\"btn btn-info\" href=\"";
            // line 55
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("edit-statut-projet", array("id" => $this->getAttribute($context["statut"], "id", array()))), "html", null, true);
            echo "\">
...
";
    ...
    {
        return "BackOfficeBundle:StatutProjet:list.html.twig";
    }
