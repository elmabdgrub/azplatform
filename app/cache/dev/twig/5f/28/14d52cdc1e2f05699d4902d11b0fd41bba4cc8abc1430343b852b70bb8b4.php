...
/* BackOfficeBundle:Tranche:edit.html.twig */
class __TwigTemplate_5f2814d52cdc1e2f05699d4902d11b0fd41bba4cc8abc1430343b852b70bb8b4 extends Twig_Template
{
...
\t\t\t\t\t\t<h2><i class=\"halflings-icon white edit\"></i><span class=\"break\"></span>Modifier tranche</h2>
\t\t\t\t\t\t<div class=\"box-icon\">
\t\t\t\t\t\t\t
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t";
        // line 64
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "datepaiment", array()), 'widget', array("attr" => array("class" => "input-prepend")));
        echo "
...
";
    ...
    {
        return "BackOfficeBundle:Tranche:edit.html.twig";
    }
