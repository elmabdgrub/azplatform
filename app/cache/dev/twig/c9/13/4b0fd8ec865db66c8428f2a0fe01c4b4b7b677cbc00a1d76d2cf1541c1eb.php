...
\t\t\t\t\t\t<a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("view-projet", array("id" => $this->getAttribute($this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "projet", array()), "id", array()))), "html", null, true);
        echo "\" title=\"retour au projet\"><i class=\"halflings-icon white cog\"></i></a>
\t\t\t\t\t<a href=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("edit-tache", array("id" => $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "id", array()))), "html", null, true);
        echo "\" title=\"Modifier la tâche\"><i class=\"halflings-icon white wrench\"></i></a>
\t\t\t\t\t<a href=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("delete-tache", array("id" => $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "id", array()))), "html", null, true);
...
\t\t\t\t\t\t\t\t<strong>Date de début : </strong>";
        // line 47
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "datedebut", array()), "d/m/Y"), "html", null, true);
        echo " <br><br>
\t\t\t\t\t\t\t\t<strong>Date de fin prévisionnelle  : </strong>";
        // line 48
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "datefinprevis", array()), "d/m/Y"), "html", null, true);
        echo " <br><br>
\t\t\t\t\t\t\t\t<strong>Date fin réele : </strong>";
        // line 49
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "datefinreel", array()), "d/m/Y"), "html", null, true);
        echo " <br><br>
\t\t\t\t\t\t\t\t<strong>Projet : </strong><a href=\"";
        // line 50
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("view-projet", array("id" => $this->getAttribute($this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "projet", array()), "id", array()))), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "projet", array()), "titre", array()), "html", null, true);
        echo "</a><br/>
...
\t\t\t\t\t\t\t\t<strong><a href=\"";
            // line 101
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("desaffect-collaborateur", array("id" => $this->getAttribute($context["prod"], "id", array()), "tache" => $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "id", array()))), "html", null, true);
...
\t\t\t<a class=\"btn btn-info\" href=\"";
            // line 308
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("affect-collaborateur", array("id" => $this->getAttribute($context["collaborateur"], "id", array()), "tache" => $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "id", array()))), "html", null, true);
...
\t\t\t\turl: \"";
        // line 378
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("messages-taches", array("id" => $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "id", array()))), "html", null, true);
        echo "\",
\t\t\t\tsuccess:
\t\t\t\t\t\tfunction(retour){
