...
\t\t\t\t\t\t<a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("detail-projet", array("id" => $this->getAttribute($this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "projet", array()), "id", array()))), "html", null, true);
...
\t\t\t\t\t\t\t\t</span>
    ...
    ";
            } elseif (($this->getAttribute($this->getAttribute($context["fichier"], "collaborateur", array()), "id", array()) == $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "id", array()))) {
                // line 174
                echo "        ";
    ...
    <script>
        function refresh() {
            \$.ajax({
                url: \"";
        // line 358
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("messages-tache", array("id" => $this->getAttribute((isset($context["tache"]) ? $context["tache"] : $this->getContext($context, "tache")), "id", array()))), "html", null, true);
        echo "\",
                success:
                        function(retour){
